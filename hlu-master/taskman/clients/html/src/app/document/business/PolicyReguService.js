...
(function () {
    ...
    angular.module('Hrm.Document').service('PolicyReguService', PolicyReguService);

    PolicyReguService.$inject = [
        '$http',
        '$q',
        '$filter',
        'settings',
    ...
    function PolicyReguService($http, $q, $filter, settings, utils) {
        var self = this;
