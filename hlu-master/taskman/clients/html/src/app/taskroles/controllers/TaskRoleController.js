 ...
 */
        ...
        vm.deleteTaskRoles = function () {
            ...
            modalInstance.result.then(function (confirm) {
                if (confirm == 'yes') {
                	console.log(vm.selectedTaskRoles);
                    service.deleteTaskRoles(vm.selectedTaskRoles, function success() {

                        // Refresh list
                        vm.getTaskRoles();

                        // Notify
                        toastr.info('Bạn đã xóa thành công ' + vm.selectedTaskRoles.length + ' bản ghi.', 'Thông báo');
