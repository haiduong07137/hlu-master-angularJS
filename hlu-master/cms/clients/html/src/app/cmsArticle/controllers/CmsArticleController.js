...
(function () {
    ...
    function CmsArticleController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service, Upload, cmsCategoryService, cmsArticleTypeService,$state,$window) {
