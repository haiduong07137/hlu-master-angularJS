(function () {
    ...
    Hrm.factory('letterIndocumentFactory',['$state',function($state){
        return {
            letterFunc: function(letterId,state){
                if(state == 'view'){
                    $state.go('application.forward_letter_in',{state:'view',letter_id:letterId});
                }else 
