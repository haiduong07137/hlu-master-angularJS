...
(function () {
    ...
    function TaskController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service) {
 ...
 */
        ...
        vm.getTasks = function () {
            service.getTasks(vm.pageIndex, vm.pageSize).then(function (data) {
        ...
        vm.newTask = function () {
            ...
            modalInstance.result.then(function (confirm) {
                if (confirm == 'yes') {
                    ...
                    service.saveTask(vm.salaryItem, function success() {
         ...
         * @param accountId
         */
        $scope.editTask = function (salaryItemId) {
            service.getTask(salaryItemId).then(function (data) {
        ...
        vm.deleteTasks = function () {
            ...
            modalInstance.result.then(function (confirm) {
                if (confirm == 'yes') {
                	console.log(vm.selectedTasks);
                    service.deleteTasks(vm.selectedTasks, function success() {

                        // Refresh list
                        vm.getTasks();

                        // Notify
                        toastr.info('Bạn đã xóa thành công ' + vm.selectedTasks.length + ' bản ghi.', 'Thông báo');
