...
(function () {
    ...
    Hrm.LetterManagement.config(['$stateProvider', function ($stateProvider) {
        ...
        $stateProvider
            ...
            .state('application.new_letter_out', {
                url: '/new_letter_out',
                templateUrl: 'letter_management/views/new_letter_out.html',
                data: {
                    icon: 'fa fa-book',
                    pageTitle: 'Văn bản mới vào sổ'
                },
                controller: 'NewLetterOutController as vm',
                resolve: {
                    deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            name: 'Hrm.NewLetterOut',
                            insertBefore: '#ng_load_plugins_before',
                            files: [
                                'letter_management/controllers/NewLetterOutController.js',
                                'letter_management/business/LetterManagementService.js'
                            ]
                        });
                    }]
            ...
            .state('application.edit_letter_out', {
                url: '/edit_letter_out/{state}/{letter_id}',
                templateUrl: 'letter_management/views/edit_letter_out.html',
                data: {
                    icon: 'fa fa-book',
            ...
            // Văn bản đi đang xử lý
            .state('application.transfer_leader_letter_out', {
                url: '/edit_letter_out/{state}/{letter_id}',
                templateUrl: 'letter_management/views/edit_letter_out.html',
                data: {
                    icon: 'fa fa-book',
                ...
                controller: 'ProcessLetterOutController as vm',
                resolve: {
                    deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            name: 'Hrm.TransferLeaderLetterOut',
                            insertBefore: '#ng_load_plugins_before',
                            files: [
                                'letter_management/controllers/ProcessLetterOutController.js',
                                'letter_management/business/LetterManagementService.js',
                                'document_type/business/DocumentTypeService.js',
                                'document_field/business/DocumentFieldService.js',
                                'document_priority/business/DocumentPriorityService.js',
            ...
            // Văn bản đi đang xử lý
            .state('application.check_letter_out', {
                url: '/edit_letter_out/{state}/{letter_id}',
                templateUrl: 'letter_management/views/edit_letter_out.html',
                data: {
                    icon: 'fa fa-book',
            ...
            // Văn bản đi đang xử lý
            .state('application.process_letter_out', {
                url: '/process_letter_out',
                templateUrl: 'letter_management/views/process_letter_out.html',
                data: {
                    icon: 'fa fa-book',
                    pageTitle: ' Văn bản đang xử lý'
                },
            ...
            .state('application.document_out', {
                url: '/edit_document_out',
                templateUrl: 'letter_management/views/edit_document_out.html',
                data: {
                    icon: 'fa fa-book',
                    pageTitle: 'Quản lý dự thảo'
                },
                controller: 'EditLetterOutController as vm',
                resolve: {
                    deps: ['$ocLazyLoad', function ($ocLazyLoad) {
            ...
            // Văn bản đã phát hành
            .state('application.add_letter_out', {
                url: '/add_letter_out',
                templateUrl: 'letter_management/views/add_letter_out.html',
                data: {
                    icon: 'fa fa-book',
                    pageTitle: 'Vào sổ văn bản'
                },
                controller: 'AddLetterOutController as vm',
                resolve: {
                    deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            name: 'Hrm.AddLetterOut',
                            insertBefore: '#ng_load_plugins_before',
                            files: [
                                'letter_management/controllers/AddLetterOutController.js',
                                'letter_management/business/LetterManagementService.js'
                            ]
                        });
                    }]
            ...
            // toàn bộ văn bản đi
            .state('application.letter_management_out', {
                url: '/letter_management_out',
                templateUrl: 'letter_management/views/letter_management_out.html',
                data: {
                    icon: 'fa fa-book',
                    pageTitle: 'Văn bản đã chuyển đi'
                },
                controller: 'LetterManagementOutController as vm',
                resolve: {
                    deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            name: 'Hrm.LetterManagementOut',
                            insertBefore: '#ng_load_plugins_before',
                            files: [
                                'letter_management/controllers/LetterManagementOutController.js',
                                'letter_management/business/LetterManagementService.js'
                            ]
                        });
                    }]
            ...
            // Toàn bộ văn bản
            .state('application.all_letter_document', {
                url: '/all_letter_document',
                templateUrl: 'letter_management/views/all_letter_document.html',
                data: {
                    icon: 'fa fa-book',
                    pageTitle: 'Toàn bộ văn bản'
                },
                controller: 'AllLetterDocumentController as vm',
                resolve: {
                    deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            name: 'Hrm.AllLetterDocument',
                            insertBefore: '#ng_load_plugins_before',
                            files: [
                                'letter_management/controllers/AllLetterDocumentController.js',
                                'letter_management/business/LetterManagementService.js'
                            ]
                        });
                    }]
            ...
            // Tìm kiếm văn bản
            .state('application.search_letter_document', {
                url: '/search_letter_document',
                templateUrl: 'letter_management/views/search_letter_document.html',
                data: {
                    icon: 'fa fa-book',
                    pageTitle: 'Tìm kiếm văn bản'
                },
                controller: 'SearchLetterDocumentController as vm',
                resolve: {
                    deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            name: 'Hrm.SearchLetterDocument',
                            insertBefore: '#ng_load_plugins_before',
                            files: [
                                'letter_management/controllers/SearchLetterDocumentController.js',
                                'letter_management/business/LetterManagementService.js'
                            ]
                        });
                    }]
