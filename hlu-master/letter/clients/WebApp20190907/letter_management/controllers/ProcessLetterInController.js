...
(function () {
    ...
    angular.module('Hrm.LetterManagement').controller('ProcessLetterInController', ProcessLetterInController);

    ProcessLetterInController.$inject = [
        '$rootScope',
        '$scope',
        'toastr',
        '$timeout',
    ...
    function ProcessLetterInController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service, Upload,$state,FileSaver,letterIndocumentFactory,$sce) {
        ...
        getPageLetterInByText(3, -1, vm.pageIndex, vm.pageSize);
        ...
        vm.bsTableControl = {
                options: {
                    ...
                    onPageChange: function (index, pageSize) {
                        ...
                        vm.pageIndex = index;
                        getPageLetterInByText(3, -1, vm.searchObject, vm.pageIndex, vm.pageSize);
                    }
                }
            };
