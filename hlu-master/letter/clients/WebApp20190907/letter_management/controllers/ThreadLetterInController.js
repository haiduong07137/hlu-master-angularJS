...
(function () {
    ...
    angular.module('Hrm.LetterManagement').controller('ThreadLetterInController', ThreadLetterInController);

    ThreadLetterInController.$inject = [
        '$rootScope',
        '$scope',
        'toastr',
        '$timeout',
    ...
    function ThreadLetterInController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service, Upload,$state,FileSaver,letterIndocumentFactory,$sce) {
