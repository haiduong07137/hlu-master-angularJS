...
(function () {
    ...
    angular.module('Hrm.Document').controller('CollaborationProcessesController', CollaborationProcessesController);

    CollaborationProcessesController.$inject = [
        '$rootScope',
        '$scope',
        'toastr',
        '$timeout',
    ...
    angular.module('Hrm.Document').directive('myDatePicker', function () {
        return {
            restrict: 'A',
            require: '?ngModel',
    ...
    function CollaborationProcessesController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service,Upload) {
