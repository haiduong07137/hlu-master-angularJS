...
(function () {
    ...
    function ProcessLetterInController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service, Upload,$state,letterIndocumentFactory) {
         ...
         * 
         */
        getPageLetterInByIndex(3,-1,vm.pageIndex,vm.pageSize);
