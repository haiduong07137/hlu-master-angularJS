...
(function () {
    ...
    function NewLetterInController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service, Upload,$state,letterIndocumentFactory) {
         ...
         * 
         */
        getPageLetterInByIndex(0,-1,vm.pageIndex,vm.pageSize);
