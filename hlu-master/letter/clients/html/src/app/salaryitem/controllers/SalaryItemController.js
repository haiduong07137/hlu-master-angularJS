            ...
            modalInstance.result.then(function (confirm) {
                if (confirm == 'yes') {
                    ...
                    service.saveSalaryItem(vm.salaryItem, function success() {
                        console.log(vm.salaryItem);
                        // Refresh list
                        vm.getSalaryItems();

                        // Notify
                        toastr.info('Bạn đã tạo mới thành công một phần tử lương.', 'Thông báo');

                        // clear object
                        vm.salaryItem = {};
                    }, function failure() {
                        toastr.error('Có lỗi xảy ra khi thêm mới một phần tử lương.', 'Thông báo');
                    });
                }
            }, function () {
                vm.salaryItem = {};
                ...
                modalInstance.result.then(function (confirm) {
                    if (confirm == 'yes') {
                        ...
                        service.saveSalaryItem(vm.salaryItem, function success() {
                            ...
                            toastr.error('Có lỗi xảy ra khi lưu thông tin phần tử lương.', 'Lỗi');
                        });
                    }
                }, function () {
                    vm.salaryItem = {};
