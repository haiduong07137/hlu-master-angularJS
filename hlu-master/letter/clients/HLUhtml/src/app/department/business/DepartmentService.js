...
(function () {
    ...
    function DepartmentService($http, $q, $filter, settings, utils) {
        ...
        self.getTaskOwnerFromDepartment = getTaskOwnerFromDepartment;
        ...
        function createTaskOwner(departmentDto, successCallback, errorCallback) {
            var url = baseUrl + 'taskman/taskowner/save_from_department';

            return utils.resolveAlt(url, 'POST', null, departmentDto, {
                'Content-Type': 'application/json; charset=utf-8'
            }, successCallback, errorCallback);
        }
        ...
        function getTaskOwnerFromDepartment(departmentId) {
            ...
            var url = baseUrl + 'taskman/taskowner/get_one_from_department/' + departmentId;
            return utils.resolve(url, 'GET', angular.noop, angular.noop);
        }
