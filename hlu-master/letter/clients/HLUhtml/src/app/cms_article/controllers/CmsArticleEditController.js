...
(function() {
    ...
    function CmsArticleEditController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service, Upload, cmsCategoryService, $state) {
        ...
        const m = moment(vm.article.publishDate);
        // vm.article.publishDate = m.add(7, 'hours').toDate();
        vm.article.publishDate = m.toDate();
        ...
        vm.startUploadFile = function(file) {
            ...
            if (file) {
                file.upload = Upload.upload({
                    url: vm.baseUrl + 'letter/upload/file',
                ...
                file.upload.then(function(response) {
                    ...
                    toastr.info('Tải lên file thành công.', 'Thông báo');
                }, function errorCallback(response) {
                    toastr.error('Tải lên file bị lỗi.', 'Lỗi');
                });
            }
        };
        ...
        vm.removeImg = function() {
            vm.article.titleImageUrl = null;
            console.log(vm.article.titleImageUrl);
        }
