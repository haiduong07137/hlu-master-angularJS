            ...
            $rootScope.$on('$locationChangeSuccess', function(event) {
                ...
                $http.get(settings.api.baseUrl + 'api/users/getCurrentUser').success(function(response, status, headers, config) {
                    ...
                    if (response) {
                        ...
                        //                        $scope.currentUser = $cookies.getObject(constants.cookies_user);
                        $http.get(settings.api.baseUrl + 'api/taskman/user_task_owner/check_user_has_taskrole/' + response.username + '/ClerkRole').success(function(data) {
                            $rootScope.hasClerkRole = data;
                        });
                        $http.get(settings.api.baseUrl + 'api/taskman/user_task_owner/check_user_has_taskrole/' + response.username + '/FowardRole').success(function(data) {
                            $rootScope.hasFowardRole = data;
                        });
                        $http.get(settings.api.baseUrl + 'api/taskman/user_task_owner/check_user_has_taskrole/' + response.username + '/ChairmanCalendarRole').success(function(data) {
                            $rootScope.hasChairmanCalendarRole = data;
                        });
                        $http.get(settings.api.baseUrl + 'api/taskman/user_task_owner/check_user_has_taskrole/' + response.username + '/ManagerCalendarRole').success(function(data) {
                            $rootScope.hasManagerCalendarRole = data;
                        });
                        $http.get(settings.api.baseUrl + 'api/taskman/user_task_owner/check_user_has_taskrole/' + response.username + '/ManagerRole').success(function(data) {
                            $rootScope.hasManagerRole = data;
                        });
                        $http.get(settings.api.baseUrl + 'api/taskman/user_task_owner/check_user_has_taskrole/' + response.username + '/ChiefOfStaffRole').success(function(data) {
                            $rootScope.hasChiefOfStaffRole = data;
                        });
