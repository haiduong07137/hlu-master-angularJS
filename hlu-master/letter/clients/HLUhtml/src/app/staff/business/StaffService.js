...
(function() {
    ...
    function StaffService($http, $q, $filter, settings, utils) {
        ...
        function validateStaffCode(staffcode, staffId, successCallback, errorCallback) {
            var url = baseUrl + 'staff/validatestaffcode/' + staffId;
            return utils.resolveAlt(url, 'POST', { staffCode: staffcode }, null, {
                'Content-Type': 'application/json; charset=utf-8'
            }, successCallback, errorCallback);
        }

        function validateUserName(username, userId, successCallback, errorCallback) {
            var url = baseUrl + 'staff/validateusername/' + userId;
        ...
        function getPositionTitles() {
            var url = baseUrl + 'positiontitle/list/0/1000';
            return utils.resolve(url, 'GET', angular.noop, angular.noop);
        }
