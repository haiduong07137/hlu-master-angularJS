...
@EnableJpaRepositories(basePackages = { "com.globits.core.repository", "com.globits.calendar.repository",
		"com.globits.hr.repository", "com.globits.security.repository", "com.globits.hr.timesheet.repository" })
public class DatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		factory.setPackagesToScan("com.globits.core.domain", "com.globits.calendar.domain", "com.globits.hr.domain",
				"com.globits.security.domain","com.globits.hr.timesheet.domain");
